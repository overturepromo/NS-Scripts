 ...
 *Author: Kevin Doss
 *Date: 06/23/2021
 *Description: Scheduled Script to send Sales Orders to DoorDash Australia WMS
 ...
 */
 ...
 function sendSO() {
	...
	//DDAUSCC Orders Pending to WMS Australia
	var results = nlapiSearchRecord('salesorder','customsearch3074');
    ...
    var callBackorderScript = function() {
      //call ad-hoc script to create backordered order
      var script = nlapiScheduleScript('customscript_op_sched_doordashausbackord');

      if(script == 'QUEUED') {
        nlapiLogExecution('AUDIT','SUCCESS', 'Backorder script successfully queued.');
      }
      else {
        throw new Error('problem scheduling backorder script');
      }
    };
